...
export function serialize() {
    ...
    // Usando las funciones oficiales de Baileys para acceder a WebMessageInfo
Object.defineProperties(proto.WebMessageInfo.prototype, {
    ...
    chat: {
        get() {
            ...
            return this.key?.remoteJid || senderKeyDistributionMessage || ''
        }
    },
    isGroup: {
        get() {
        ...
        return proto?.jidNormalizedUser 
            ? proto.jidNormalizedUser(jid)
            : jid // por si algo falla, que no truene
    }
},
        isGroup: {
            get() {
